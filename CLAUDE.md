...
Travel Trails — CMS for travel trails travel agency. Stack: Next.js, TypeScript, Supabase, Netlify.
...
- Add data-testid for all input elements to help locating elements on the DOM for playwright
